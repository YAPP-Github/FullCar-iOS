...
final class CarPullDetailViewModel {
    ...
    func applyFullCar() async {
        do {
            try await callListAPI.applyCarpull(formId: Int(carPull.id), pickupLocation: carPull.pickupLocation, peroidType: carPull.periodType.rawValue, money: carPull.money, content: carPull.content ?? "")
        } catch {
